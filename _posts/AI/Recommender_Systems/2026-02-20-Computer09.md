...
$\min_{q^*,\, p^*} \sum_{(u,i)\in K} \left( r_{ui} - q_i^\top p_u \right)^2 
...
추천시스템은 종종 <span style="color: blue">**콜드 스타트 문제(cold start problem)**가 있습니다. (이전 논문 정리글 참고)<br>
...
사용자가 어떤 item을 많이 소비했다고해서 벡터 크기가 과도하게 커질 경우 <span style="color: blue"> normalization </span>을 히면 도움이 되며, 예를들어 다음과 같이 사용할 수 있습니다. <br> <br><br>
